...
public class File extends IdentifiedObject {
	 ...
	 * 
	 * @param user
	 *            usuari que afegeix una revisió sobre un fitxer
	 * @param dateTime
	 *            data de la revisió
	 * @param newSourceCode
	 *            codi de la revisió
	 ...
	 */
	public void addRevision(User user, Date dateTime, String newSourceCode, int idRevision) {
	 ...
	 * 
	 * @param idRevision
	 *            identificador de la revisió a buscar
	 ...
	 */
	public Iterador<Revision> ItRevisions() {
